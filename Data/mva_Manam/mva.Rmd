...
* 0.4% of the Crúbadán corpus contains apostrophes, which aren't typical of the Manam orthography. Upon speculation, these occurances seem to appear only in biblical texts, most likely representing the glottal stop, just as in other Austronesian languages. In the rule set, I transcribe apostrophes to glottal stops, but it can be excluded if need be.
...
* /s/ and (more commonly) /z/ may be realized as affricates (ibid.).
