...
**Compromised: diacritics not always marked, creating phonemic ambiguity; certain diacritics used interchangeably**
...
* The two diphthongs generally associated with Indo-Aryan languages /ɔi/ and /ɔu/ (variants of /ai/ and /au/), may be interpreted as separate monophthongs [@Ray2003, p. 447]. So, I have chosen not to transcribe them as complex nuclei.
...
* Oriya is descended from the Brahmi script, but it does not hang from a horizontal line. It is a left-to-right abugida script without capital letters. As an abugida script, every consonant carries an inherent /ɔ/ following it [@Ray2003, p. 487].
...
"ଂ"                            "/m/"     "called an anusvara, this diacritic represents a nasal, either word-finally or in homoorganic sequences (/m/ appears to be underlying) [@Mahapatra1996, p. 404; @Mohapatra2016, p. 23]"
...
* Aspirated consonants are deaspirated when preceded by /s/ and followed by a vowel [@Ray2003, p. 449].
