...
**Slightly Compromised: possible conflation with /i/ and /j/ due to syllable structure**


# Background

**Language family**: Tupi / Tupi-Guarani / Kayabi-Arawete (V)
...
* Kayabí makes a contrastive distinction between oral and nasal vowels [@Souza2004, p. 24].
...
* Consonants may also weaken when morpheme-initial [@Souza2004, pp. 27-28]:
    ...
    * /k/ may become [ŋ].
* Morpheme-final consonants may become elided when preceded by a morpheme-initial consonant [@Souza2004, p. 28].
