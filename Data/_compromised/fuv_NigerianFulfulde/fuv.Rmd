...
* Glottal stops are not always represented word-initially, which compromizes the language slightly [@McIntosh1982, p. 25].
* There is also some ambiguity related to how the palatalized glottal stop (including geminate form) is represented. I've listed the different forms below. I have gone with the transcription represented in @Ahmad2014 (pp. 5, 7), given that such forms (non-geminate) appear in the Crúbadán corpus, whereas the forms based on the transcription of @McIntosh1982 do not appear (p. 23).
...
"\'y"           "/ʔʲ/"  "geminate form: ⟨\'\'y⟩ [@McIntosh1982, p. 23]"
**Digraph**      ""               ""
"mb"            "/ᵐb/"            ""
"nd"            "/ⁿd/"            ""
"nj"            "/ⁿdʒ/"           ""
...
* Long vowels may undergo degemination when occurring in word-final unstressed syllables (ie. the length distinction in this position is neutralized) [@McIntosh1982, p. 25].
