...
**Compromised: uncertainty related to how reliable the glottal stop is marked; uncertainty surrounding the orthography (Crúbadán includes symbols not present in the alphabet)**
...
kable(consonants, col.names = c("Manner of Articulation", "Labial", "Alveolar", "Postalveolar", "Palatal", "Velar", "Uvular", "Glottal"), align = 'c') %>%
  ...
  footnote(general = "Note: For phonemes that share a cell, those on the left are plain and those on the right are implosives.", general_title = "")
```

## Vowels

* Vowel length is contrastive in Tz'utujil [@Dayley1985, p. 25]. Long vowels are represented by duplicate graphemes.
* /ie/ and /uo/ are present in the Santiago Atitlan dialect [@Dayley1985, p. 27]. However, I have not included them, given that I'm not focusing on a specific dialect.
...
* **/t’/ does not appear in the Crúbadán corpus.**
...
* /p’/ and /t’/ become voiced and implosive preceding vowels [@Dayley1985, p. 15]. Ejective /q/ may become voiced and implosive in the same environment, but it's optional.
