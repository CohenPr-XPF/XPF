...
* I have opted to go with the analysis that includes voiced stops, so the Karo dialect is reflected more closely below.
...
* Vowels cannot occur in succession [@Toland1991, p. 2].
