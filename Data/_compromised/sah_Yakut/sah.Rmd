...
* Also referred to as Sakha, it is spoken in Russia.
...
kable(consonants, col.names = c("Manner of Articulation", "Labial", "Alveolar", "Palatal", "Velar", "Glottal"), align = 'c') %>%
  ...
  footnote(general = "Note: From left to right, phonemes in a cell are plain, aspirated, and voiced. The palatal approximant on the right is nasalized.", general_title = "") %>%
...
* The distinction between /j/ and /j̃/ is not marked in the orthography [@tolkov_phonetics_2011, p. 2].
