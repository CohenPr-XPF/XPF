...
**Slightly Compromised: alphabet is ambiguously phonetic with nasal vowels**
...
* Nasal vowels might have originated as allophonic in /VN/ clusters [@ChoBroadwell2005, p. 17]; @ChoNicklas1975 and @ChoUlrich1986 seems to bolster this view (pp. 237-8; pp. 8, 60). Between this and the relatively rare usage of their unique characters, I have decided to treat the nasal vowels as allophonic and exclude them from the ruleset.
...
* The alphabet I am using is the Modified Traditional orthography (sometimes also called the modern linguistic variant), which is used by most contemporary linguists [@ChoBroadwell2005, p. 6] as well as by Crúbadán. The ruleset will also support the Mississippi Choctaw orthography, which is also popularly used today, but it will not support the Traditional orthography since the Traditional orthography does not distinguish vowel length [@ChoBroadwell2005, p. 4].
