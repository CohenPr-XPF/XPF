...
**Slightly Compromised: Crúbadán doesn't distinguish orthographically between retroflex and alveolar consonants; conflation between /u/ and /w/ and between /u/ and /o/**
...
* There may be some conflation among the retroflex and alveolar consonants, given that some orthographies don't make a distinction between them [@Fleck2003, p. 84].
* There may also be some conflation with /u/ and /w/ and with /o/ and /u/ given that in some documentation, they are represented by ⟨u⟩ and ⟨o⟩ [@Fleck2003, pp. 64 91].
...
* /n/ assimilates to the place of articulation preceding velar and bilabial stops [@Fleck2003, p. 62].
