...
**Slightly Compromised: /h/ only represented orthographically when contrast is required**
...
* A small ring above a word-final syllable indicates /j/; however, Crúbadán doesn't seem to follow this convention, opting for ⟨ᔾ⟩, the convention of which is consistent with the other word-final consonants [@Ellis2000, p. 465].
