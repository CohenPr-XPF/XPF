...
* Bilabial and labiodental consonants are non-contrastive in Turkic languages [@TtBaitchura1975, p. 244], so /f/ could theoretically also be /ɸ/. Comrie explicitly describes this consonant as bilabial [@TtComrie1997, p. 901], but he diverges from a general consensus of using /f/. I have opted for the labiodental /f/ in the phonemic inventory below.
