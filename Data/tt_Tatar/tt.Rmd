...
{2}: Bilabial and labiodental consonants are non-contrastive in Turkic languages (Baitchura, p. 244), so this consonant could theoretically also be /ɸ/. Comrie explicitly describes this consonant as bilabial (Comrie, p. 901), but he diverges from a general consensus of using /f/.
