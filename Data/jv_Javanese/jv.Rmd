...
{1}: Wolff does not depict this consonant as assimilating, but Nothofer and Horne do. Because (at least some) other prenasalized stops feature nasal assimilation, and because /ŋ/ is phonemic in Javanese, I have followed his example. Relatedly, I personally find it likely that nasal assimilation occurs in /nɖ/ and /nɟ/, but because I have been able to find attestation for such assimilation, I have not included it in my ruleset.
...
Vowels may occur successively, but they do not form diphthongs when doing so. ([@JvSuharno1982], p. 2)

## Stress

Stress falls on the penult, unless the vowel of the penult is /ə/, which is never stressed in Javanese. ([@JvRobson2014], p. xvi)
...
l - /l/  
m - /m/  
n - /n/ (does retroflex n exist, and is it here?)  
o - /o/  
...
**/h/-deletion:**  
lungguh - /luŋɡuh/ - to sit; lungguhan - /luŋɡuan/ - sitting  
