...
Prior to 1950, Guarani used a different orthographical system [@GnOrthography, pages 4-5]. Because the grapheme <y> represents a different phoneme in each Guarani orthography (/dʒ/ in the old orthography vs. /ɯ/ in the current one), it is impossible to represent both systems in a single ruleset, so I have opted only to include the current orthography.
