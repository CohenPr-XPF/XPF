...
* /ʐ/ is said to be a phoneme by @MtoCrawford1963, occurring intervocalically and following nasals (p. 44). However, I feel that occurrences of this is a due to a voicing process. @MtoSchoenhals1965 states that the phonemes only occurs in loanwords (p. 300). For these reasons, I have chosen not to include it below.
