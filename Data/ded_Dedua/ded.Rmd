...
* The diphthongs listed below are always seen as complex nuclei according to @McEvoy2005 (p. 270).
...
* Glottal stops and /ŋ/ are the only phonemes that can appear in syllable codas [@McEvoy2005, p. 268], so complex consonants are always realized as such.
