...
kable(consonants, col.names = c("Manner of Articulation", "Labial", "Alveolar", "Postalveolar", "Palatal", "Velar", "Glottal"), align = 'c') %>%
  ...
  footnote("Note: In cells with multiple phonemes, the leftmost is plain or aspirated; the second is ejective; and where a third phoneme is present, it is voiced.", general_title = "") %>%
