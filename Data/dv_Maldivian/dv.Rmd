...
* The palatal nasal appears as well; however, @DeSilva1969 explains that it is not phonemic. @Cain2000 explain that it is a fusion of /n̪/ and /i/, which I have chosen to treat the corresponding grapheme as such.
...
* Diphthongs are represented with an inflected alifu ⟨އ⟩ following a consonant with a fili or with two fili on an alifu (above and below) [@Gnanadesikan2012, pp. 94, 96].
...
* /k/, /ʂ/, and /t̪/ debuccalize to glottal stops prepausally or to velar nasals word-finally preceding word-initial vowels or /h/ [@Cain2000, pp. 11-12].
* /s̪/ becomes /h/ morpheme-finally preceding a vowel-initial suffix [@Gnanadesikan2016, p. 44].
* Morpheme-final /u/ deletes preceding a vowel-initial suffix (ibid.).
