...
* Only liquids ⟨r⟩ and ⟨l⟩ geminate in Palauan [@Carlson1968, p. 27].
...
* /ə/ only appears in unstressed syllables, and consequently, it is not universally considered to be phonemic in Palauan [@PauJosephs1975, p. 22]. It is interpreted as an allophone of /ɛ/, or a phonetic realization based on context [@Carlson1968, p. 36]. It is represented by ⟨ȩ⟩ in the alphabet; however, it's not present in the Crúbadán corpus. Nonetheless, I have chosen to represent it in the rule set as /ɛ/.
