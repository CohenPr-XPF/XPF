...
* Asturian is spoken in north-west Spain.
...
* /i/ and /u/ become glides [j] and [w] respectively, when unstressed, forming dipthongs and triphthongs with adjoining vowels [@muniz-cachon_asturian_2018, p. 6].
...
* Primary stress is indicated by an accented vowel [@academia_de_la_llingua_asturiana_gramatica_2001, p. 18].  

# Lenition Rules

* Fricatives /θ/, /s/, /ʃ/ and tend to become voiced in coda positions [@academia_de_la_llingua_asturiana_gramatica_2001, pp. 39-40].  
...
* Dashes are used to separate sounds that would otherwise be altered due to specified digraphs (retention of pronouns) [@academia_de_la_llingua_asturiana_gramatica_2001, p. 18].  
