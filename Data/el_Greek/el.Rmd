...
kable(alphabet, col.names = c("Uppercase", "Lowercase", "", ""), align = 'c') %>%
  kable_styling("bordered") %>%
  add_header_above(c("Grapheme" = 2, "Phoneme" = 1, "Comment" = 1))
```  

# Lenition Rules

* In fast speech, adjacent identical vowels across word boundaries degeminate [@Arvaniti1999, p. 4].
* Word-final /s/ becomes voiced when preceding a word-initial voiced consonant (ibid.).
...
* /k/, /g/, /x/, /ɣ/ surface as palatal allophones [c], [ɟ], [ç], [ʝ] in front of high vowels /i/ and /ε/ [@Arvaniti1999, p. 3].
