...
"Manner of Articulation"   Labial  Alveolar  Alveolo-Palatal   Palatal    Velar    Glottal
"Stops (plain)"            "p b"    "t d"          ""          "c ɟ"     "k kʷ"      ""
Affricates                  ""      "ts"          "tɕ"          ""         ""        ""
Fricatives                  ""      "s"           "ɕ"           ""         ""        "h"
Nasals                     "m"      "n"           ""            "ɲ"        ""        ""
Flaps                       ""      "ɺ"           ""            ""         ""        ""
...
kable(consonants, col.names = c("Manner of Articulation", "Labial", "Alveolar", "Alveo-Palatal", "Palatal", "Velar", "Glottal"), align = 'c') %>%
  kable_styling("bordered") %>%
  add_header_above(c("", "Place of Articulation" = 6)) %>%
  footnote("Note: For phonemes that share a cell, those on the left are voiceless and those on the right are voiced. The velar stop on the right is voiceless and labialized. Both palatal approximants are voiced, but the one on the right is lateral.", general_title = "") %>%
...
* Cavineña is said to have a pitch-accent system (high and mid) [@Guillaume2008, p. 42]; however, it's not contrastive.
...
* There seems to be four different writing systems laid out by @Guillaume2008 (p. 48).
...
* Syllables in Cavineña follow the order of (C)V [@Guillaume2008, 30].
    ...
    * Thus, the language may be compromised to some extent.
