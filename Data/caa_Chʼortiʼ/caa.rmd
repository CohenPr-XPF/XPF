...
kable(consonants, col.names = c("Manner of Articulation", "Bilabial", "Alveolar", "Postalveolar", "Palatal", "Velar", "Glottal"), align = 'c') %>%
  ...
  footnote(general = "Note: The bilabial stops are ordered voiceless, voiced, implosive. The alveolar and velar stops are ordered voiceless, ejective, voiced. The alveolar and postalveolar affricates are ordered voiceless, ejective.", general_title = "") %>%
