...
* Although /ɡ/ and /w/ were once considered allophones in Chʼortiʼ and still occur in free variation in some environments (eg. preceding /o/), they are classified as distinct phonemes [@hull2016, p. 8].
...
* /b/, /d/, and /ɡ/ are said to appear mainly in Spanish loanwords [@dugan2013, p. 18]; however, I have opted to include them, just as @hull2016 does (p. 7).
...
kable(consonants, col.names = c("Manner of Articulation", "Bilabial", "Alveolar", "Postalveolar", "Palatal", "Velar", "Glottal"), align = 'c') %>%
  ...
  footnote(general = "Note: The bilabial stops are ordered voiceless, voiced, and implosive. The alveolar and velar stops are ordered voiceless, ejective, and voiced. The alveolar and postalveolar affricates are ordered voiceless and ejective.", general_title = "") %>%
...
* Vowel length is sometimes indicated by an accent mark over the vowel or by a postvocalic ⟨h⟩ [@Fought2012, p. 45]. However, given that vowel length is not contrastive, such accented vowels will be transcribed as short vowels. In addition, the postvocalic ⟨h⟩ is purely used to separate elements, thus it has no phonemic realization (ibid.).  
