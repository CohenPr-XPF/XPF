...
* The "saltillo" is the term used to collectively refer to the glottal consonants (/ʔ/ and /h/) in Nahuatl. Although they are typically considered interchangeable, both consonants are considered phonemic in this dialect. There are three characters sometimes used to indicate the saltillo: ⟨h⟩, ⟨j⟩, or ⟨'⟩. Grave accents (\`) on vowels have also been used to indicate following glottal stops. In assigning each character a specific phoneme, I have worked from my understanding of which is more common, represented below in the table.
