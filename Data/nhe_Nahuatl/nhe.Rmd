...
* @NheBeller1979 includes /ɡ/ as a phoneme that occurs, although rarely, in native words (p. 204); however, the Crúbadán corpus does not feature ⟨g⟩ except in loaned proper nouns, so based on current evidence I have opted to omit it.
