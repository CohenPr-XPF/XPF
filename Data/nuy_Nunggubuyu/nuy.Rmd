...
* /n̪/ appears only rarely, in a handful of animal-related nouns [@NuyHeath1984, p. 12]. It does not appear in the Crúbadán corpus.
...
* @NuyHughes1971 lists /æ/ as part of the vowel inventory, albeit only marginally (p. 72). Other authors do not share this view, so I have opted not to include it below.
