...
**Language family**: Trans-New Guinea / Madang / Croisilles / Mabuso / Hanseman / Garuh-Foran
...
kable(consonants, col.names = c("Manner of Articulation", "Labial", "Alveolar", "Palatal", "Velar", "Glottal"), align = 'c') %>%
  ...
  footnote(general = "Note: The voiceless stops are ordered plain and long and the voiced stops are ordered plain and implosive.", general_title = "")
```
