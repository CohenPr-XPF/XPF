...
kable(consonants, col.names = c("Manner of Articulation", "Labial", "Alveolar", "Postalveolar", "Palatal", "Velar", "Uvular", "Glottal"), align = 'c') %>%
  ...
  footnote(general = "Note: Where two phonemes share a cell, those on the left are voiceless and those on the right are voiced. Where three phonemes share a cell, they are ordered voicless, aspirated, and voiced.", general_title = "")
```
