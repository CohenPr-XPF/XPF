...
* Albanian also has four diphthongs, that @SqNewmark1982 states are always realized as complex phonemes (p. 12). However, he does state that there is variation in terms of realization. Additionally, @SqCamaj1984 states that new documentation identifies these sequences as separate phonemes. I have chosen to include them in the ruleset.
