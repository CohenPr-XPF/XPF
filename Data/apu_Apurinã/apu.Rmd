...
**Note: /ɨ̃/, /ɲ/, /j/, and /ɰ/ do not appear in the Crúbadán corpus.**
...
* Voicing is not contrastive in Apurinã [@facundes_language_2000, p. 70].
...
* In addition to oral diphthongs, Apurinã includes nasal diphthongs, although these are extremely infrequent (these won't be accounted for) [@facundes_language_2000, pp. 85-87].
...
* /h/ deletes when followed by a vowel (ibid.).
