...
* Consonants do not geminate [@Caballero2007, pg. 5].
* Glottal stops only appear word-medially [@FelixArmendariz2005, pg. 11].
...
* Accents are put over the vowels to indicate stress, but there's no indication that it affects the realization of the phoneme [@Miller1993, p. 25].
...
* /s/ palatalizes preceding /i/[@Miller1993, p. 27].
* Preceding /i/, /e/, and /u/, /ɾ/ may be realized as retroflex [@Miller1993, p. 27].
